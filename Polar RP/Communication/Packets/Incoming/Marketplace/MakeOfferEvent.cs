...
namespace Polar.Communication.Packets.Incoming.Marketplace
{
    internal class MakeOfferEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            {
                Session.SendNotification("Lo siento, solo Rares & LTDs pueden ser subastados en el Mercado!");
                return;
            }
            ...
            int Comission = PolarEnvironment.GetGame().GetCatalog().GetMarketplace().CalculateComissionPrice((float)SellingPrice);
