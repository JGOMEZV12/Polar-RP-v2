...
namespace Polar.Communication.Packets.Outgoing.Moderation
{
    internal class ModeratorUserInfoComposer : ServerPacket
    {
        ...
        public void Compose(ServerPacket packet)
        {
            ...
            packet.WriteInteger(User != null ? Convert.ToInt32(Math.Ceiling((PolarEnvironment.GetUnixTimestamp() - Convert.ToDouble(User["account_created"])) / 60)) : 0);
            packet.WriteInteger(User != null ? Convert.ToInt32(Math.Ceiling((PolarEnvironment.GetUnixTimestamp() - Convert.ToDouble(User["last_online"])) / 60)) : 0);
            packet.WriteBoolean(User != null ? PolarEnvironment.GetGame().GetClientManager().GetClientByUserID(Convert.ToInt32(User["id"])) != null : false);
            ...
            packet.WriteString("");//user_internal classification
        }
    }
}
