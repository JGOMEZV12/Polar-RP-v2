...
{
    class GetGuestRoom2ResultComposer : ServerPacket
    {
        public GetGuestRoom2ResultComposer(GameClient Session, RoomData Data, Boolean isLoading, Boolean checkEntry)
