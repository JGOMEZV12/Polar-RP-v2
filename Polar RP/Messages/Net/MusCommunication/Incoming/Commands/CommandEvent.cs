...
{
    class CommandEvent : IMusPacketEvent
    {
        public async Task Parse(MusConnection MUS, MusPacketEvent Packet)
        {
            string[] Params = Packet.PacketData.Split('|');

            GameClient Client = null;

            String header = Params[0];
            String param = (Packet.PacketData.Split(Convert.ToChar(1)).Count() > 1) ? Packet.PacketData.Split(Convert.ToChar(1))[1] : "";
            ...
            switch (header.ToLower())
            {
                ...
                case "alert_user":
                    {
                        int UserId = Convert.ToInt32(Params[1]);
                        string alertMessage = Convert.ToString(Params[2]);
                ...
                case "givebadge":
                    {
                        int UserId = Convert.ToInt32(Params[1]);
                        string badgeCode = Convert.ToString(Params[2]);
                        Client = PolarEnvironment.GetGame().GetClientManager().GetClientByUserID(UserId);
                ...
                case "goto":
                    {
                        int UserId = Convert.ToInt32(Params[1]);
                        int RoomId = Convert.ToInt32(Params[2]);
                ...
                case "give_vip":
                    {
                        int UserId = Convert.ToInt32(Params[1]);
                        int dAmount = Convert.ToInt32(Params[2]);
                        int cAmount = 500;
                        int num = 31 * 1;
                ...
                case "progress_achievement":
                    {
                        ...
                        string Achievement = Convert.ToString(Params[2]);
                ...
                case "test":
                    {
                        Console.WriteLine("Entro aqui con = > " + Params[1] + " | => " + Params[2]);
