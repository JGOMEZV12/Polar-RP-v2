...
using Polar.HabboRoleplay.Combat.Types;
using log4net;

namespace Polar.HabboRoleplay.Combat
{
    ...
    public static class CombatManager
    {
        ...
        /// log4net
        /// </summary>
        private static readonly ILog log = LogManager.GetLogger("Polar.HabboRoleplay.Combat.CombatManager");
        ...
        public static void Initialize()
        {
           ...
           // log.Info("CombatManager (" + CombatTypes.Count + ") -> LOADED!");
            Out.WriteLine("CombatManager -> CARGADO", "Polar..HabboRoleplay.Combat.CombatManager", ConsoleColor.DarkGray);
        }
