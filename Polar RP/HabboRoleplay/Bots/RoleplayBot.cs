...
namespace Polar.HabboRoleplay.Bots
{
    public class RoleplayBot : IDisposable
    {
        ...
        public Room GenerateSpawnRoom
        {
            get
            {
                RoleplayManager.GenerateRoom(this.SpawnId, out Room room, false);
                return (SpawnId <= 0) ? null : room;
            }
        }
        ...
        public GameClient Owner { get { if (PolarEnvironment.GetGame() == null || PolarEnvironment.GetGame().GetClientManager() == null) return null; return ((this.OwnerId <= 0) ? null : PolarEnvironment.GetGame().GetClientManager().GetClientByUserID(this.OwnerId)); } }
        #endregion
        ...
        public void StartTeleporting(RoomUser Self, Room Room, object[] Params)
        {
            ...
            HabboRoleplay.Misc.RoleplayManager.GenerateRoom(TeleRoomId, out Room NewRoom, false);
        ...
        public void HandleTeleporting(RoomUser Self, Room Room)
        {
            ...
            if (!Bot.Teleported)
            {
                ...
                if (Self.Coordinate == Bot.TeleporterEntering.Coordinate)
                {
                    ...
                    RoleplayManager.GenerateRoom(Bot.TeleporterExiting.RoomId, out Room TeleRoom, false);
        ...
        public Item GetLinkedTeleport(Item EnteringTeleport)
        {
            ...
            RoleplayManager.GenerateRoom(TeleRoomId, out Room NewRoom, false);
        ...
        public void InitiateDeath()
        {
            ...
            this.OSpawnId = Bot.GetRoom().Id;
            RoleplayBotManager.TransportDeployedBot(Bot, HospitalRID, true);
        ...
        public string[] GetOutFit()
        {
            ...
            if (this.Dead)
            {
                ...
                Outfit[1] = "[DEAD] Hospital Patient";
            }
            else if (this.Jailed)
            {
                ...
                Outfit[1] = "[JAILED] Jail Inmate [#" + PrisonNumber + "]";
            }
            else if (User != null && User.GetBotRoleplayAI() != null && User.GetBotRoleplayAI().OnDuty)
            {
                if (this.WorkUniform != "none")
                    Outfit[0] = RoleplayManager.SplitFigure(this.Figure, this.WorkUniform);

                Outfit[1] = "[TRABAJANDO] " + GroupManager.GetJob(this.Corporation).Name + " " + GroupManager.GetJobRank(this.Corporation, 1).Name;
            }
