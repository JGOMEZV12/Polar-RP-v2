            ...
            try
            {
                ...
                if (Client != null && Client.GetRoomUser() != null && Client.GetRoleplay() != null && !Client.LoggingOut && Client.GetRoleplay().IsDead)
                {
                    ...
                    if (Item != null)
                    {
                        ...
                        base.CachedBot.DRoomUser.Chat("Déjame inyectarte esta aguja " + Client.GetHabbo().Username + " para ayudarte", true);
            ...
            try
            {
                ...
                new Thread(() =>
                {
                    ...
                    while (count < limit)
                    {
                        ...
                        if ((limit - count) == 60)
                            Client.SendWhisper("¡Tienes 1 minuto de tiempo restante para revivir", 34);
                        else if ((limit - count) == 30)
                            Client.SendWhisper("¡Tienes 30 segundos de tiempo restante para revivir", 34);
                        else if ((limit - count) == 10)
                            Client.SendWhisper("¡Tienes 10 segundos de tiempo restante para revivir", 34);
                    ...
                    if (count >= limit && Client != null && Client.GetRoomUser() != null && Client.GetRoleplay() != null && !Client.LoggingOut)
                    {
                        if (Client.GetRoleplay().IsDead)
                        {
                            ...
                            Client.SendWhisper("Se le da de alta temprano gracias a la ayuda de los médicos", 1);
                        }
                    }
                }).Start();
