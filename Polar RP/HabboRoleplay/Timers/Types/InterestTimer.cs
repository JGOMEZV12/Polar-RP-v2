    ...
    public class InterestTimer : RoleplayTimer
    {
        ...
        public override void Execute()
        {
            try
            {
                ...
                {
                    base.Client.GetRoleplay().CreateCaptcha("¡Introduzca el código en el cuadro para seguir recaudando el interés!");
                    return;
                }
                ...
                base.Client.SendWhisper("Recibiste una notificación en tu teléfono, tu cuenta de ahorros se ha ganado $" + Interest + " en intereses.", 1);
                return;
            }
            catch (Exception e)
            {
