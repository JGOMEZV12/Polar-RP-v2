...
namespace Polar.HabboHotel.Items.Televisions
{
    public class TelevisionManager
    {
        private static readonly ILog log = LogManager.GetLogger("Polar.HabboHotel.Items.Televisions.TelevisionManager");
        ...
        public void Init()
        {
            ...
            using (IQueryAdapter dbClient = PolarEnvironment.GetDatabaseManager().GetQueryReactor()) 
            {
                ...
                if (getData != null)
                {
                    ...
                    {
                        this._televisions.Add(Convert.ToInt32(Row["id"]), new TelevisionItem(Convert.ToInt32(Row["id"]), Row["youtube_id"].ToString(), Row["title"].ToString(), Row["description"].ToString(), PolarEnvironment.EnumToBool(Row["enabled"].ToString())));
                    }
                }
            }
