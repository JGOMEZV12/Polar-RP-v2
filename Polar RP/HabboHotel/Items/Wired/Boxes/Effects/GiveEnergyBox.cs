...
{
    class GiveEnergyBox : IWiredItem
    {
        public Room Instance { get; set; }
        public Item Item { get; set; }
        public WiredBoxType Type { get { return WiredBoxType.EffectGiveEnergy; } }
        public ConcurrentDictionary<int, Item> SetItems { get; set; }
        public string StringData { get; set; }
        public bool BoolData { get; set; }
        public string ItemsData { get; set; }

        public GiveEnergyBox(Room instance, Item item)
        {
        ...
        public bool Execute(params object[] Params)
        {
            ...
            if (!int.TryParse(StringData, out int energy))
                return false;

            var rp = Player.GetClient().GetRoleplay();
            rp.CurEnergy += energy;
            if (rp.CurEnergy > rp.MaxEnergy)
                rp.CurEnergy = rp.MaxEnergy;
