...
using Polar.Communication.Packets.Outgoing.Rooms.Freeze;
using Polar.HabboHotel.Rooms.Games.Teams;
using Polar.HabboHotel.Items.Wired;
using Polar.HabboHotel.Users.Effects;

namespace Polar.HabboHotel.Rooms.Games.Freeze
{
    public class Freeze
    {
        private Room _room;
        ...
        {
            return ExitTeleports.Values.ToList()[PolarEnvironment.GetRandomNumber(0, ExitTeleports.Count - 1)];
        }
