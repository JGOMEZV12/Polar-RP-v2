...
namespace Polar.HabboHotel.Rooms
{
    public class RoomPromotion
    {
        ...
        public RoomPromotion(string Name, string Desc, int CategoryId)
        {
            ...
            this._timestampStarted = PolarEnvironment.GetUnixTimestamp();
            this._timestampExpires = (PolarEnvironment.GetUnixTimestamp()) + (PolarStaticGameSettings.RoomPromotionLifeTime * 60);
        ...
        {
            get { return (this.TimestampExpires - PolarEnvironment.GetUnixTimestamp()) < 0; }
        }

        public int MinutesLeft
        {
            get { return Convert.ToInt32(Math.Ceiling((this.TimestampExpires - PolarEnvironment.GetUnixTimestamp()) / 60)); }
        }
