...
namespace Polar.HabboHotel.Rooms.Chat.Commands.Users.Jobs.General
{
    class PromoteCommand : IChatCommand
    {
        ...
        {
            get { return "command_corp_promote"; }
        }
        ...
        {
            get { return "Promueve uno de los trabajadores de su corporación."; }
        }
        ...
        public async Task Execute(GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            {
                if (!GroupManager.HasJobCommand(Session, "promote"))
                {
                 ...
                 /*if ((Session.GetRoleplay().JobRank - 1) == JobRank)
                 {
                     Session.SendWhisper("Usted no puede promover a un trabajador al mismo rango que usted", 1);
                     return;
                 }*/
            ...
            {
                Session.SendWhisper("¡Ya no puedes promocionar a tu trabajador!", 1);
                return;
            }
            #endregion
            ...
            Session.Shout("*Asciende a " + TargetClient.GetHabbo().Username + " en " + Job.Name + " " + Rank.Name + "*", Bubble);
            #endregion
        }
    }
}