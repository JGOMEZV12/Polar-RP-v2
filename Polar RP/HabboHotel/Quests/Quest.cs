namespace Polar.HabboHotel.Quests
{
    public class Quest
    {
        ...
        public readonly bool IsRP;

        public Quest(int Id, string Category, int Number, QuestType GoalType, int GoalData, string Name, int Reward, string DataBit, int RewardType, int TimeUnlock, int TimeLock, bool IsRP)
        {
            this.Id = Id;
            ...
            this.IsRP = IsRP;
            this.HasEnded = (TimeLock >= PolarEnvironment.GetUnixTimestamp() && TimeLock > 0) ? true : false;
        }
