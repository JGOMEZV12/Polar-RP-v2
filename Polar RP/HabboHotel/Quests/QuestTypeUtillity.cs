    ...
    public class QuestTypeUtillity
    {
        public static string GetString(QuestType type)
        {
            switch (type)
            {
                ...
                case QuestType.DISCHARGE_USER:
                    return "discharge_user";
                case QuestType.HEAL_USER:
                    return "heal_user";

                case QuestType.PUNCH_USER:
                    return "punch_user";
                case QuestType.KILL_USER:
                    return "kill_user";

                case QuestType.EAT_FOOD:
                    return "eat_food";
                case QuestType.DRINK_DRINK:
                    return "drink_drink";

                case QuestType.ARREST_USER:
                    return "arrest_user";
                case QuestType.EVADE_ARREST:
                    return "evade_arrest";
