...
namespace Polar.HabboHotel.Quests
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Polar.HabboHotel.Quests.QuestManager");
        ...
        public void Init()
        {
            ...
            using (IQueryAdapter dbClient = PolarEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                ...
                if (dTable != null)
                {
                    foreach (DataRow dRow in dTable.Rows)
                    {
                        ...
                        bool isrp = PolarEnvironment.EnumToBool(dRow["is_rp"].ToString());
            ...
            //log.Info("Loaded " + _quests.Count + " quests.");
        }
        ...
        public void ProgressUserQuest(GameClient Session, QuestType QuestType, int EventData = 0)
        {
            ...
            if (PassQuest)
            {
                ...
                Session.GetRoleplay().UpdateTimerDialogue("Mission-Passed", "add", 0, 0);
