...
namespace Polar.HabboHotel.Users.Permissions
{
    /// <summary>
    ...
    public sealed class PermissionComponent
    {
        ...
        public bool Init(Habbo Player)
        {
            ...
            this._permissions.AddRange(PolarEnvironment.GetGame().GetPermissionManager().GetPermissionsForPlayer(Player));
            this._commands.AddRange(PolarEnvironment.GetGame().GetPermissionManager().GetCommandsForPlayer(Player));
            return true;
        }
